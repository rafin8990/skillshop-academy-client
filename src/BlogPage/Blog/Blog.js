            ...
            <div className='mt-10 p-4 grid sm:grid-cols-2 md:grid-cols-3'>
                <div className=' border border-gray-500 rounded-lg ml-3 mr-3 mt-3 shadow-sm'>
                    <div className='border border-gray-500 p-2'>
                        <h1 className='text-amber-500 text-4xl'>What is Cors?</h1>
                    </div>
                ...
                <div className=' border border-gray-500 rounded-lg ml-3 mr-3 mt-3 shadow-sm'>
                    <div className='border border-gray-500 p-2'>
                        <h1 className='text-amber-500 text-4xl'>Why are you using firebase? What other options do you have to implement authentication?</h1>
                    </div>
                    <p className='text-amber-500 text-xl p-2'>Answer: </p>
                    <p className='text-amber-500 p-2'>
                ...
                <div className=' border border-gray-500 rounded-lg ml-3 mr-3 mt-3 shadow-sm'>
                    <div className='border border-gray-500 p-2'>
                        <h1 className='text-amber-500 text-4xl'> How does the private route work?</h1>
                    </div>
                    <p className='text-amber-500 text-xl p-2'>Answer: </p>
                    <p className='text-amber-500 p-2'>
                ...
                <div className=' border border-gray-500 rounded-lg ml-3 mr-3 mt-3 shadow-sm'>
                    <div className='border border-gray-500 p-2 shadow-sm rounded-sm'>
                        <h1 className='text-amber-500 text-4xl'> What is Node? How does Node work?</h1>
                    </div>
                    <p className='text-amber-500 text-xl p-2'>Answer: </p>
                    <p className='text-amber-500 p-2'>
