...
const Blog = () => {
    return (
        <div className=''>
            ...
            {/* question cover side  */}
            <div className='sm:flex items-center shadow-sm rounded-xl'>
                <div className=' m-8'>
                    <h1 className='text-4xl sm:text-5xl font-bold text-orange-500'>Do You Want To Learn About FireBase & Node Js?</h1>
                    <h3 className='text-3xl text-amber-500'>Let's know something about Firebase. </h3>
                </div>
                <div className='p-8'>
            ...
            <div className='mt-10 p-4 grid sm:grid-cols-2 md:grid-cols-3'>
                <div className=' border border-border-black rounded-lg ml-3 mr-3 mt-3 shadow-sm'>
                    <div className='border border-border-black p-2'>
                        <h1 className='text-black text-4xl'>What is Cors?</h1>
                    </div>
                    <p className='text-black text-xl p-2'>Answer: </p>
                ...
                <div className=' border border-border-black rounded-lg ml-3 mr-3 mt-3 shadow-sm'>
                    <div className='border border-border-black p-2'>
                        <h1 className='text-black text-4xl'>Why are you using firebase? What other options do you have to implement authentication?</h1>
                    </div>
                    <p className='text-black text-xl p-2'>Answer: </p>
                    <p className='text-black p-2'>
                ...
                <div className=' border border-border-black rounded-lg ml-3 mr-3 mt-3 shadow-sm'>
                    <div className='border border-border-black p-2'>
                        <h1 className='text-black text-4xl'> How does the private route work?</h1>
                    </div>
                    <p className='text-black text-xl p-2'>Answer: </p>
                    <p className='text-black p-2'>
                ...
                <div className=' border border-border-black rounded-lg ml-3 mr-3 mt-3 shadow-sm'>
                    <div className='border border-black p-2 shadow-sm rounded-sm'>
                        <h1 className='text-black text-4xl'> What is Node? How does Node work?</h1>
                    </div>
                    <p className='text-black text-xl p-2'>Answer: </p>
                    <p className='text-black p-2'>
